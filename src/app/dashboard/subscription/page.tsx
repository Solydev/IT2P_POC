    ...
    <div className="p-4 sm:p-6 lg:p-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="max-w-sm mb-10">
          <div className="relative bg-a2p-surface rounded-lg p-6 shadow-sm border border-a2p-accent ring-2 ring-a2p-accent/20">
            ...
            <ul className="space-y-2.5 mb-6">
              {plan.features.map((f, i) => (
                <li key={i} className="flex items-center gap-2 text-sm">
                  ...
                  <span className="text-a2p-text">{f.label}</span>
                </li>
              ))}
            </ul>
            <button className="w-full py-2.5 rounded-lg font-medium text-sm bg-a2p-accent text-white hover:bg-a2p-accent-hover transition-colors">
              S&apos;abonner
            </button>
          </div>
        </div>
